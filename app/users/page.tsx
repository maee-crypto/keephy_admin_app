...
import { Plus, Search, Edit, Trash2, Eye, User, Shield, Mail, Calendar, Building2, Filter } from 'lucide-react';
  ...
  useEffect(() => {
    const mockUsers: User[] = [
      ...
      },
      {
        ...
        subscription: { planName: 'Enterprise', status: 'active' }
      },
      {
        id: '3',
        name: 'Mike Rodriguez',
      ...
      },
      {
        ...
        subscription: { planName: 'Starter', status: 'pending' }
      },
      {
        id: '5',
        name: 'David Wilson',
      ...
      },
      {
        id: '7',
        name: 'Robert Brown',
        email: 'robert@billing.com',
        role: 'billing',
        status: 'active',
        lastLogin: '2024-03-14T14:30:00Z',
        createdAt: '2024-01-20T11:00:00Z',
        permissions: ['view_billing', 'manage_subscriptions', 'view_invoices'],
        subscription: { planName: 'Professional', status: 'active' }
      },
      {
        id: '8',
        ...
        permissions: ['manage_brand', 'view_brand_analytics', 'manage_brand_staff'],
        subscription: { planName: 'Professional', status: 'cancelled' }
      }
    ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Complete user directory across all organizations</p>
        </div>
        <button
